...
public class UserAccountSettings implements Parcelable {
    ...
    private long followers; // That is not required in my application
    private long following; // That is not required in my application
    private long posts; // That is not required in my application
